...
public class FoodShopPrefab : MonoBehaviour
{
    ...
    public int basePrice; //FoodShopで代入済
    public int price;  //FoodShopで代入済
    public int effectValue;  //FoodShopでReferenceToIncreaseXp()にて代入済
    public int mealTime; //FoodShop.csで代入済

    // Start is called before the first frame update
    void Start()
    {
        priceText.text = price + "円";
        effectText.text = "効果：+" + effectValue;
